package cn.sunshine.component.common.exception;
...
public class SunshineException extends RuntimeException {
	...
	public SunshineException(IErrorCode errorCode,Object...message) {
		super(String.format(errorCode.getMsg(), message));
        this.errorCode = errorCode;
    }
