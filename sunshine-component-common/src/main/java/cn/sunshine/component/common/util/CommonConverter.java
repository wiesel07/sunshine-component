...
public class CommonConverter<S, T> {
	...
	public CommonResp<T> copyCommonPage(IPage<S> page, Class<T> t){
        return new CommonResp(copyPage(page,t));
    }
     ...
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public CommonResp<T> copyCommonObject(Object s,Class<T> t){
        return new CommonResp(copyObject(s,t));
    }
